...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('creme_config_settingvalue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['creme_config.SettingKey'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('value_str', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('creme_config', ['SettingValue'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('creme_config_settingvalue')
