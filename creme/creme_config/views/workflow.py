...
# TODO: factorise with 'WorkflowActionAddingWizard'
class WorkflowActionAddingWizard(base.ConfigModelEditionWizard):
    ...
    def get_object(self, *args, **kwargs):
        ...
        if not instance.is_custom:
            raise ConflictError(_('This Workflow cannot be edited'))
...
class WorkflowActionEdition(base.ConfigModelEdition):
    ...
    def get_action(self):
        try:
            ...
            raise Http404(_('This action does not exist anymore')) from e
    ...
    def get_title(self):
        return _('Edit the action «{}»').format(self.get_action().verbose_name)
...
class WorkflowActionDeletion(base.ConfigDeletion):
    ...
    def perform_deletion(self, request):
        ...
        try:
            ...
            raise ConflictError(_('This action is invalid (refresh your page)')) from e
