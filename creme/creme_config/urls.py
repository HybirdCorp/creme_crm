...
user_patterns = patterns('creme.creme_config.views.user',
    (r'^portal/$',                        'portal'),
    (r'^add/$',                           'add'),
...
team_patterns = patterns('creme.creme_config.views.user',
    (r'^add/$',                  'add_team'),
...
property_type_patterns = patterns('creme.creme_config.views.creme_property_type',
    (r'^portal/$',                           'portal'),
    (r'^add/$',                              'add'),
...
button_menu_patterns = patterns('creme.creme_config.views.button_menu',
    (r'^portal/$',             'portal'),
    (r'^add/$',                'add'),
...
history_patterns = patterns('creme.creme_config.views.history',
    (r'^portal/$', 'portal'),
    (r'^add/$',    'add'),
    (r'^delete$',  'delete'),
)

setting_patterns = patterns('creme.creme_config.views.setting',
    (r'^edit/(?P<svalue_id>\d+)$',   'edit'),
    (r'^(?P<app_name>\w+)/reload/$', 'reload_block'),
)

urlpatterns = patterns('creme.creme_config.views',
    (r'^$',             'portal.portal'),
    ...
    (r'^(?P<app_name>\w+)/(?P<model_name>\w+)/add_widget/$',                'generics_views.add_model_from_widget'),
