...
urlpatterns = [
    ...
    re_path(r'^(?P<app_name>\w+)/reload[/]?$',       generics_views.AppBricksReloading.as_view(), name='creme_config__reload_app_bricks'),
    re_path(r'^(?P<app_name>\w+)/(?P<model_name>\w+)/', include([
        ...
        re_path(r'^reload[/]?$',                        generics_views.ModelBrickReloading.as_view(), name='creme_config__reload_model_brick'),
    ])),
]
