...
role_patterns = [
    ...
    url(r'^add[/]?$',                               user_role.add,                              name='creme_config__create_role_legacy'),  # DEPRECATED
    url(r'^edit/(?P<role_id>\d+)[/]?$',             user_role.edit,                             name='creme_config__edit_role_legacy'),    # DEPRECATED
...
fields_config_patterns = [
    ...
    url(r'^add[/]?$',                    fields_config.add,                         name='creme_config__create_fields_config_legacy'),  # DEPRECATED
...
bricks_patterns = blocks_patterns = [
    ...
    url(r'^portal/add[/]?$',                    bricks.add_portal,                   name='creme_config__create_portal_bricks_legacy'),  # DEPRECATED
    ...
    url(r'^relation_block/add_ctypes/(?P<rbi_id>\d+)[/]?$',                bricks.add_ctypes_2_relation_block,        name='creme_config__add_ctype_config_to_rtype_brick'),  # DEPRECATED
    ...
    url(r'^custom/add[/]?$',                       bricks.add_custom_block,            name='creme_config__create_custom_brick_legacy'),  # DEPRECATED
...
button_menu_patterns = [
    ...
    url(r'^add[/]?$',                 button_menu.add,                        name='creme_config__add_buttons_to_ctype_legacy'),  # DEPRECATED
...
setting_patterns = [
    ...
    url(r'^(?P<app_name>\w+)/reload[/]?$', setting.reload_block, name='creme_config__reload_settings_block'),  # DEPRECATED
]
...
urlpatterns = [
    ...
    url(r'^models/(?P<ct_id>\d+)/reload[/]?$', generics_views.reload_block,       name='creme_config__reload_model_block_legacy'),  # DEPRECATED
    ...
    url(r'^(?P<app_name>\w+)/(?P<model_name>\w+)/', include([
        ...
        url(r'^down/(?P<object_id>[\w-]+)[/]?$',    generics_views.swap_order, {'offset': 1},  name='creme_config__move_instance_down'),  # DEPRECATED
        url(r'^up/(?P<object_id>[\w-]+)[/]?$',      generics_views.swap_order, {'offset': -1}, name='creme_config__move_instance_up'),    # DEPRECATED
