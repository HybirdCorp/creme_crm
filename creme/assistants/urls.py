...
#    (r'^memo/delete/(?P<memo_id>\d+)/$',           'memo.delete'),
...
#    (r'^alert/delete/(?P<alert_id>\d+)/$',          'alert.delete'),
...
#    (r'^todo/delete/(?P<todo_id>\d+)/$',           'todo.delete'),
...
#    (r'^action/delete/(?P<action_id>\d+)/$',         'action.delete'),
