...
def replace_ct_4_image(apps, schema_editor):
    ...
    if ct_doc is not None:
        ...
        for model in ('Action', 'Alert', 'Memo', 'ToDo', 'UserMessage'):
            get_model('assistants', model).objects.filter(entity_content_type=ct_img) \
...
class Migration(migrations.Migration):
    dependencies = [
        ...
        ('assistants', '0004_v1_7__textfields_not_null_2'),
    ]
