...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'ToDo.reminded'
        db.add_column('assistants_todo', 'reminded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False,
                     )

        # Adding field 'Alert.reminded'
        db.add_column('assistants_alert', 'reminded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False,
                     )

        # Changing field 'UserMessage.priority'
        db.alter_column('assistants_usermessage', 'priority_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assistants.UserMessagePriority'], on_delete=models.PROTECT),
                       )

    def backwards(self, orm):
        # Deleting field 'ToDo.reminded'
        db.delete_column('assistants_todo', 'reminded')

        # Deleting field 'Alert.reminded'
        db.delete_column('assistants_alert', 'reminded')

        # Changing field 'UserMessage.priority'
        db.alter_column('assistants_usermessage', 'priority_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['assistants.UserMessagePriority'])
                       )
