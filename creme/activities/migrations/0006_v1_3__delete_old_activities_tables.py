...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Renaming field 'Activity.activity_place' in 'Activity.place'
        db.rename_column('activities_activity', 'activity_place', 'place')

        # Renaming field 'Activity.activity_duration' in 'Activity.duration'
        db.rename_column('activities_activity', 'activity_duration', 'duration')

    def backwards(self, orm):
        # Renaming field 'Activity.duration' in 'Activity.activity_duration'
        db.rename_column('activities_activity', 'duration', 'activity_duration')

        # Renaming field 'Activity.place' in 'Activity.activity_place'
        db.rename_column('activities_activity', 'place', 'activity_place')
