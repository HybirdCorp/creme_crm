...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Removing unique constraint on 'Calendar', fields ['name']
        db.delete_unique('activities_calendar', ['name'])

    def backwards(self, orm):
        # Adding unique constraint on 'Calendar', fields ['name']
        db.create_unique('activities_calendar', ['name'])
