...
class Migration(DataMigration):
    def _set_internal(self, orm, is_internal):
        rt_get = orm['creme_core.RelationType'].objects.get

        try:
            sub_rt = rt_get(id="activities-subject_participates_to_activity")
            obj_rt = rt_get(id="activities-object_participates_to_activity")
        except Exception as e:
            pass
        else:
            sub_rt.is_internal = obj_rt.is_internal = is_internal

            sub_rt.save()
            obj_rt.save()

    def forwards(self, orm):
        self._set_internal(orm, True)

    def backwards(self, orm):
        self._set_internal(orm, False)
    ...
    complete_apps = ['creme_core', 'activities']
