...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Adding field 'Status.is_custom'
        db.add_column('activities_status', 'is_custom', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Activity.activity_place'
        db.add_column('activities_activity', 'activity_place', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Activity.activity_duration'
        db.add_column('activities_activity', 'activity_duration', self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Activity.sub_type'
        db.add_column('activities_activity', 'sub_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.ActivitySubType'], null=True, blank=True), keep_default=False)

        # Adding field 'Activity.floating_type'
        db.add_column('activities_activity', 'floating_type', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

    def backwards(self, orm):
        # Deleting model 'ActivitySubType'
        db.delete_table('activities_activitysubtype')

        # Deleting field 'Status.is_custom'
        db.delete_column('activities_status', 'is_custom')

        # Deleting field 'Activity.activity_place'
        db.delete_column('activities_activity', 'activity_place')

        # Deleting field 'Activity.activity_duration'
        db.delete_column('activities_activity', 'activity_duration')

        # Deleting field 'Activity.sub_type'
        db.delete_column('activities_activity', 'sub_type_id')

        # Deleting field 'Activity.floating_type'
        db.delete_column('activities_activity', 'floating_type')
