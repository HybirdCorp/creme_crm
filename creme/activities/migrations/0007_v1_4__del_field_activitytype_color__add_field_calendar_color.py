...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        # Adding field 'Calendar.color'
        db.add_column('activities_calendar', 'color',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Activity.type'
        db.alter_column('activities_activity', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.ActivityType'], on_delete=models.PROTECT))

        # Changing field 'Activity.sub_type'
        db.alter_column('activities_activity', 'sub_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.ActivitySubType'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Adding field 'ActivityType.color'
        db.add_column('activities_activitytype', 'color',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Calendar.color'
        db.delete_column('activities_calendar', 'color')


        # Changing field 'Activity.type'
        db.alter_column('activities_activity', 'type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.ActivityType']))

        # Changing field 'Activity.sub_type'
        db.alter_column('activities_activity', 'sub_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activities.ActivitySubType'], null=True))
