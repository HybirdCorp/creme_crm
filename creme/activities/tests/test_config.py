...
class CalendarConfigItemTestCase(BrickTestCaseMixin, CremeTestCase):
    ...
    def test_config_create__not_allowed(self):
        ...
        self.assertGET403(
            reverse('activities__add_calendar_settings')
        )

    def test_config_create__role_choices(self):
        self.login_as_root()

        url = reverse('activities__add_calendar_settings')
    ...
    def test_config_edit__not_allowed(self):
        ...
        self.assertGET403(
            reverse('activities__edit_calendar_settings', args=(default.pk,))
        )
    ...
    def test_config_edit(self):
        ...
        url = reverse('activities__edit_calendar_settings', args=(role_config.pk,))
    ...
    def test_config_delete__not_allowed(self):
        ...
        self.assertPOST403(reverse('activities__delete_calendar_settings'), data={
            "id": config.pk
        })
    ...
    def test_config_delete(self):
        ...
        url = reverse('activities__delete_calendar_settings')
