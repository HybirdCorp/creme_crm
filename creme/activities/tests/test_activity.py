...
class ActivityTestCase(BrickTestCaseMixin, _ActivitiesTestCase):
    ...
    def test_editview07(self):
        ...
        other_role = self.create_role(name='Other role')
        ...
        other_config = CalendarConfigItem(role=other_role)
        other_config.allow_event_overtime = False
        other_config.allow_event_anyday = False
        other_config.day_start = time(8, 0, 0)
        other_config.day_end = time(18, 0, 0)
        other_config.save()
