...
urlpatterns = [
    ...
    # Form lines
    re_path(r'^poll_form/(?P<pform_id>\d+)/add/line[/]?$',        poll_form.LineCreation.as_view(),      name='polls__create_form_line'),
    ...
    re_path(r'^pform_section/(?P<section_id>\d+)/edit[/]?$',      poll_form.SectionEdition.as_view(),       name='polls__edit_form_section'),
    re_path(r'^pform_section/(?P<section_id>\d+)/add/child[/]?$', poll_form.ChildSectionCreation.as_view(), name='polls__create_child_form_section'),
...
urlpatterns += swap_manager.add_group(
    ...
    Swappable(re_path(r'^campaign/(?P<campaign_id>\d+)[/]?$',      campaign.PollCampaignDetail.as_view(),   name='polls__view_campaign'), check_args=Swappable.INT_ID),
    app_name='polls',
).kept_patterns()
...
urlpatterns += swap_manager.add_group(
    ...
    Swappable(re_path(r'^poll_form/(?P<pform_id>\d+)[/]?$',      poll_form.PollFormDetail.as_view(),   name='polls__view_form'), check_args=Swappable.INT_ID),
    app_name='polls',
).kept_patterns()
...
urlpatterns += swap_manager.add_group(
    ...
    Swappable(re_path(r'^poll_reply/edit/(?P<preply_id>\d+)[/]?$', poll_reply.PollReplyEdition.as_view(), name='polls__edit_reply'), check_args=Swappable.INT_ID),
    Swappable(re_path(r'^poll_reply/(?P<preply_id>\d+)[/]?$',      poll_reply.PollReplyDetail.as_view(), name='polls__view_reply'),  check_args=Swappable.INT_ID),
    app_name='polls',
).kept_patterns()
