...
creme.dialog.PopoverAction.fromTarget = function(target, options, data, e) {
    ...
    if (Object.isEmpty(content)) {
        console.warn('Using directly link inner html as popover content is now deprecated; Use data-content-href or a tag script "text/html" instead');
        content = target.find('details').html();
        title = target.find('summary').text();
    }
