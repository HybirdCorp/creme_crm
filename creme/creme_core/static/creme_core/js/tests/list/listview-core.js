...
//    assert.deepEqual(creme.lv_widget.selectedLines(element), []);
    assert.equal(controller.isLoading(), false);
    assert.equal(controller.hasSelectedRows(), false);
...
//    assert.deepEqual(creme.lv_widget.selectedLines(element), ['1', '2']);
...
//    assert.deepEqual(creme.lv_widget.selectedLines(element), ['1', '2', '3']);
    assert.equal(controller.hasSelectedRows(), true);
...
//    assert.deepEqual(creme.lv_widget.selectedLines(element), ['1', '3']);
    assert.equal(controller.hasSelectedRows(), true);
});
