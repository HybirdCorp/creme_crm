...
QUnit.test('creme.listview.DownloadAction (no formats)', function(assert) {
    var list = this.createDefaultListView().controller();

    var action = new creme.lv_widget.DownloadAction(list, {
        url: '/mock/entity/merge'
    }).on(this.listviewActionListeners);
...
QUnit.test('creme.listview.DownloadAction (cancel)', function(assert) {
    var list = this.createDefaultListView().controller();
...
QUnit.test('creme.listview.DownloadAction (ok)', function(assert) {
    var list = this.createDefaultListView().controller();
