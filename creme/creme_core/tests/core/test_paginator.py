...
class FlowPaginatorTestCase(CremeTestCase):
    ...
    def test_missing_ordering(self):
        ...
        paginator = FlowPaginator(contacts.order_by("user__role"), per_page=2, count=count)
        self.assertEqual(paginator.queryset.query.order_by, ("user__role__id", "id"))
    ...
    def test_next_page02(self):
        ...
        paginator = FlowPaginator(contacts.order_by("first_name"), per_page=2, count=len(contacts))
        page = paginator.page()
        self.assertDictEqual(
            {
                'type': 'forward',
    ...
    def test_desc02(self):
        ...
        contacts = [*qs.order_by('-last_name')]
        paginator = FlowPaginator(qs, per_page=2, count=len(contacts))
        page1 = paginator.page()
        self.assertListEqual(contacts[0:2], [*page1.object_list], contacts)
        page2 = paginator.page(page1.next_page_info())
        self.assertListEqual(contacts[2:4], [*page2.object_list], contacts)
        page3 = paginator.page(page2.next_page_info())
        self.assertListEqual(contacts[4:6], [*page3.object_list], contacts)
    ...
    def test_fk_sub_field_fk01(self):
        ...
        self.assertListEqual(
            docs,
            [*FakeDocument.objects.order_by('linked_folder__category', 'id')]
        )
        self.assertListEqual(
            docs,
    ...
    def test_fk_sub_field_fk02(self):
    ...
    def test_fk_sub_field_fk03(self):
