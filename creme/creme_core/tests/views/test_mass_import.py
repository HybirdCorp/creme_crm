...
class MassImportViewsTestCase(MassImportBaseTestCaseMixin,
    ...
    def test_auxiliary_creation_error01(self):
        ...
        self.assertFormError(
            response, 'form', 'position', errors='You can not create instances',
        )
    ...
    def test_auxiliary_creation_error02(self):
        ...
        self.assertFormError(
            response, 'form', 'legal_form', errors='You can not create instances',
        )
    ...
    def test_credentials02(self):
        ...
        self.assertFormError(response, 'form', 'sector', 'You can not create instances')
