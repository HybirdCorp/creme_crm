...
class BulkUpdateTestCase(_BulkEditTestCase):
    ...
    def test_other_field_validation_error_several_entities01(self):
        ...
        user_contact1 = create_contact(self.other_user)
        user_contact2 = create_contact(self.create_user(index=2))
    ...
    def test_other_field_validation_error_several_entities02(self):
        ...
        user_contact1 = create_user_contact(self.other_user)
        user_contact2 = create_user_contact(self.create_user(index=2))
