...
class WorkflowsTestCase(CremeTestCase):
    ...
    def test_source__created_entity(self):
        ...
        ffield = deserialized.config_formfield()
    ...
    def test_source__subject_entity(self):
        ...
        ffield = source.config_formfield()
    ...
    def test_source__fixed_entity__str_uuid(self):
        ...
        ffield = FixedEntitySource.composed_config_formfield(
    ...
    def test_source__fixed_entity__render__entity_instance(self):
        user = self.get_root_user()
        orga = FakeOrganisation.objects.create(user=user, name='Acme')
    ...
    def test_source__fixed_entity__render__str_uuid(self):
        user = self.get_root_user()
        orga = FakeOrganisation.objects.create(user=user, name='Acme')
        source = FixedEntitySource(model=FakeOrganisation, entity=str(orga.uuid))
        self.assertEqual(
    ...
    def test_source__entity_fk__useless_formfield(self):
        "No FK is available."
