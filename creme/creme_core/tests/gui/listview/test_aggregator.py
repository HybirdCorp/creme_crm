...
class ListViewAggregatorTestCase(CremeTestCase):
    ...
    def test_aggregation_for_cells__several_aggregators(self):
        ...
        invoices = [
            create_invoice(name='Invoice #1', total_vat=1100, total_no_vat=1000),
            create_invoice(name='Invoice #2', total_vat=2200, total_no_vat=2000),
            create_invoice(name='Invoice #3',                 total_no_vat=100),
        ]
        ...
        self.assertEqual(Decimal(100), no_vat_results[0].value)
