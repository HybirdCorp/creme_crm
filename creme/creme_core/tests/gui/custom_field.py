...
class ValueMakerTestCase(CremeTestCase):
    ...
    def test_bool__from_dict(self):
        ...
        # with self.assertRaises(ValueError):
        #     BooleanMaker.from_dict({'value': 13})
    ...
    def test_str(self):
        ...
        # with self.assertRaises(ValueError):
        #     StringMaker.from_dict({'value': True})

    def test_str__from_string(self):
        value = 'Hello world'
        with self.assertNoException():
    ...
    def test_date__fixed(self):
        ...
        value1 = date(year=2026, month=3, day=28)
        with self.assertNoException():
            maker1 = DateMaker.from_date(value1)
        self.assertEqual(value1, maker1.make())
        self.assertDictEqual({'type': 'date', 'value': '2026-03-28'}, maker1.to_dict())
    ...
    def test_date__fixed__from_dict(self):
    ...
    def test_registry__empty(self):
        registry = DefaultValueMakerRegistry()
    ...
    def test_registry__ok(self):
        registry = DefaultValueMakerRegistry().register(IntegerMaker, BooleanMaker)
        self.assertIsInstance(registry.get_maker({}), NoneMaker)
    ...
    def test_registry__global(self):
        self.assertIsInstance(value_maker_registry, DefaultValueMakerRegistry)
        self.assertIsInstance(
