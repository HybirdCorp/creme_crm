...
class CredsValidatorTestCase(CremeTestCase):
    ...
    def test_validate_none_user(self):
        with self.assertRaises(ValidationError) as e:
            validators.validate_authenticated_user(None, 'nobody', code='viewnotallowed')
    ...
    def test_validate_authenticated_user(self):
        ...
        with self.assertNoException():
            validators.validate_authenticated_user(user, 'none or anonymous not allowed', code='viewnotallowed')
    ...
    def test_validate_linkable_entity_owner(self):
        ...
        self._set_user_credentials(user, EntityCredentials.LINK, SetCredentials.ESET_OWN)
