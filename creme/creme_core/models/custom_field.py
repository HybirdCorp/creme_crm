...
from ..gui.custom_field import DefaultValueMaker, value_maker_registry
...
class CustomField(CremeModel):
    ...
    @property
    def default_value_maker(self) -> DefaultValueMaker:
    ...
    def default_value_maker(self, value: DefaultValueMaker) -> None:
...
class CustomFieldString(CustomFieldValue):
    ...
    def get_default_value_formfield(cls, **kwargs):
        from creme.creme_core.forms.custom_field import StringMakerField
...
class CustomFieldInteger(CustomFieldValue):
    ...
    @classmethod
    def get_default_value_formfield(cls, **kwargs):
        from creme.creme_core.forms.custom_field import IntegerMakerField
...
class CustomFieldFloat(CustomFieldValue):
    ...
    @classmethod
    def get_default_value_formfield(cls, **kwargs):
        from creme.creme_core.forms.custom_field import DecimalMakerField
...
class CustomFieldDateTime(CustomFieldValue):
    ...
    #   @classmethod
    #   def get_default_value_formfield(cls, **kwargs):
    #       from creme.creme_core.forms.custom_field import DatetimeMakerField
...
class CustomFieldDate(CustomFieldValue):
    ...
    @classmethod
    def get_default_value_formfield(cls, **kwargs):
        from creme.creme_core.forms.custom_field import DateMakerField
...
class CustomFieldBoolean(CustomFieldValue):
    ...
    @classmethod
    def get_default_value_formfield(cls, **kwargs):
        from creme.creme_core.forms.custom_field import BooleanMakerField
