...
class EntityCreationTrigger(WorkflowTrigger):
    ...
    def config_formfield(cls, model):
        return wf_forms.EntityCreationTriggerField(
            model=model,
...
class EntityEditionTrigger(EntityCreationTrigger):
    ...
    @classmethod
    def config_formfield(cls, model):
        return wf_forms.EntityEditionTriggerField(
            model=model,
            label=cls.verbose_name,
        )
...
class RelationAddingTrigger(WorkflowTrigger):
    ...
    @classmethod
    def config_formfield(cls, model):
        return wf_forms.RelationAddingTriggerField(
...
class _FromContextSource(WorkflowActionSource):
    ...
    def __eq__(self, other):
        ...
        return (
            isinstance(other, type(self))
            and self._model == other._model  # TODO: test
        )
...
class EntityFKField(WorkflowActionSource):
    type_id = 'entity_fk'

    # TODO: instance => entity ?
...
class PropertyAddingAction(WorkflowAction):
    ...
    # TODO: unit test
    # TODO: complete (+ base + relation adding)
    @classmethod
    # def config_formfield(cls, model):
    def config_formfield(cls):
        return wf_forms.PropertyAddingActionField(
            # model=model, label=cls.verbose_name,
        )
