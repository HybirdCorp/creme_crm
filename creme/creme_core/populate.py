...
class Populator(BasePopulator):
    def populate(self, *args, **kwargs):
        ...
        create(FilterType, FROM_FILTER_RESULTS, name=_(u"From results of a filter"), pattern_key='%s__in',           pattern_value='%s',      is_exclude=False, type_champ="CharField", value_field_type='textfield')
