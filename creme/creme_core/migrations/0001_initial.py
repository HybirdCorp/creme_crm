...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('creme_core_relation', (
            ...
            ('subject_entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relations', to=orm['creme_core.CremeEntity'])),
            ('object_entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='relations_where_is_object', to=orm['creme_core.CremeEntity'])),
        ))
        ...
        # Adding model 'EntityCredentials'
        db.create_table('creme_core_entitycredentials', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='credentials', null=True, to=orm['creme_core.CremeEntity'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length='5')),
        ))
        db.send_create_signal('creme_core', ['EntityCredentials'])
        ...
        # Adding model 'BlockConfigItem'
        db.create_table('creme_core_blockconfigitem', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True)),
            ('block_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('order', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('on_portal', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('creme_core', ['BlockConfigItem'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EntityCredentials'
        db.delete_table('creme_core_entitycredentials')
        ...
        # Deleting model 'BlockConfigItem'
        db.delete_table('creme_core_blockconfigitem')
