...
class Migration(migrations.Migration):
    ...
    #     ('creme_core', '0156_v2_7__fileref_description.py'),
    #     ('creme_core', '0157_v2_7__portable_entity_cells.py'),
    #     ('creme_core', '0158_v2_7__portable_ctype.py'),
    #     ('creme_core', '0159_v2_7__buttonmenuitem_per_role.py'),
    #     ('creme_core', '0160_v2_7__customentitytype.py'),
    #     ('creme_core', '0161_v2_7__propertytype_description.py'),
    #     ('creme_core', '0162_v2_7__cremeuser_uuid01.py'),
    #     ('creme_core', '0163_v2_7__cremeuser_uuid02.py'),
    #     ('creme_core', '0164_v2_7__cremeuser_uuid03.py'),
    #     ('creme_core', '0165_v2_7__fileref_longer_filedata.py'),
    #     ('creme_core', '0166_v2_7__workflow.py'),
    #     ('creme_core', '0167_v2_7__currency_is_default01.py'),
    #     ('creme_core', '0168_v2_7__currency_is_default02.py'),
    #     ('creme_core', 'TODO VERSION!!'),
    # ]
