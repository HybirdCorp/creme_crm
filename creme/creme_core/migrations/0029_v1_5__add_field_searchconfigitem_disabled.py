...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'SearchConfigItem.disabled'
        db.add_column('creme_core_searchconfigitem', 'disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False,
                     )

    def backwards(self, orm):
        # Deleting field 'SearchConfigItem.disabled'
        db.delete_column('creme_core_searchconfigitem', 'disabled')
