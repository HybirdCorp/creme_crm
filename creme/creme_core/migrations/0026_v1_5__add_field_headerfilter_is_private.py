...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'HeaderFilter.is_private'
        db.add_column('creme_core_headerfilter', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'HeaderFilter.is_private'
        db.delete_column('creme_core_headerfilter', 'is_private')
