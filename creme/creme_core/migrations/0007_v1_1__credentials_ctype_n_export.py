...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SetCredentials.ctype'
        db.add_column('creme_core_setcredentials', 'ctype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SetCredentials.ctype'
        db.delete_column('creme_core_setcredentials', 'ctype_id')
