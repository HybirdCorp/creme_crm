...
class Migration(DataMigration):
    def forwards(self, orm):
        user_qs = orm['auth.User'].objects.order_by('id')

        try:
            admin = user_qs.filter(is_superuser=True, is_staff=False)[0]
        except IndexError:
            try:
                admin = user_qs.filter(is_superuser=True)[0]
            except IndexError:
                try:
                    admin = user_qs[0]
                except IndexError:
    ...
    def backwards(self, orm):
        orm['creme_core.EntityFilter'].objects.filter(is_custom=False).update(user=None)
    ...
    models = {
        ...
        'creme_core.entityfilter': {
            'Meta': {'ordering': "('name',)", 'object_name': 'EntityFilter'},
            'entity_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'primary_key': 'True'}),
            'is_custom': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'creme_core.headerfilter': {
            'Meta': {'ordering': "('name',)", 'object_name': 'HeaderFilter'},
            'entity_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
            'id': ('django.db.models.fields.CharField', [], {'max_length': '100', 'primary_key': 'True'}),
            'is_custom': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'json_cells': ('django.db.models.fields.TextField', [], {'null': 'True'}),
        ...
        'creme_core.instanceblockconfigitem': {
            'Meta': {'ordering': "('id',)", 'object_name': 'InstanceBlockConfigItem'},
