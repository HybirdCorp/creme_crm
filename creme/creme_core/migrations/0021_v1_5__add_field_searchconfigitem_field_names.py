...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'SearchConfigItem.field_names'
        db.add_column('creme_core_searchconfigitem', 'field_names',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SearchConfigItem.field_names'
        db.delete_column('creme_core_searchconfigitem', 'field_names')
