...
class Migration(SchemaMigration):
    def forwards(self, orm):
        try:
            db.rename_table('billing_vat', 'creme_core_vat')
        except DatabaseError:
            print 'Do not worry, it is normal if "billing" app was not installed. We try now to create the "Vat" table from scratch.'

            db.create_table('creme_core_vat', (
            ...
            db.send_create_signal('creme_core', ['Vat'])

    def backwards(self, orm):
        #db.delete_table('creme_core_vat')
        db.rename_table('creme_core_vat', 'billing_vat') #if billing is not installed, it creates a useless table...
