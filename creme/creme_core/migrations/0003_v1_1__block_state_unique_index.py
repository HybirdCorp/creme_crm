...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'BlockState', fields ['block_id']
        db.delete_unique('creme_core_blockstate', ['block_id'])
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'BlockState', fields ['block_id']
        db.create_unique('creme_core_blockstate', ['block_id'])
