...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'HeaderFilter.json_cells'
        db.add_column('creme_core_headerfilter', 'json_cells',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'HeaderFilter.json_cells'
        db.delete_column('creme_core_headerfilter', 'json_cells')
