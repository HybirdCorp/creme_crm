...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'EntityFilter.is_private'
        db.add_column('creme_core_entityfilter', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'EntityFilter.is_private'
        db.delete_column('creme_core_entityfilter', 'is_private')
