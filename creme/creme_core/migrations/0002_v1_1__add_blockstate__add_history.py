...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('creme_core_blockstate', (
            ...
            ('block_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
        ...
        db.create_table('creme_core_historyline', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['creme_core.CremeEntity'], null=True)),
    ...
    models = {
        ...
        'creme_core.blockstate': {
            'Meta': {'object_name': 'BlockState'},
            'block_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
