...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding model 'CustomBlockConfigItem'
        db.create_table('creme_core_customblockconfigitem', (
            ('id', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('json_cells', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('creme_core', ['CustomBlockConfigItem'])

        # Adding field 'RelationBlockItem.json_cells_map'
        db.add_column('creme_core_relationblockitem', 'json_cells_map',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'CustomBlockConfigItem'
        db.delete_table('creme_core_customblockconfigitem')

        # Deleting field 'RelationBlockItem.json_cells_map'
        db.delete_column('creme_core_relationblockitem', 'json_cells_map')
