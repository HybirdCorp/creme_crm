...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        #These FK add already these 'on_delete' attributes in 1.2 version,
        #but it seems that south ignored them.
        # Changing Relation fields 'subject_entity' & 'object_entity'
        db.alter_column('creme_core_relation', 'subject_entity_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['creme_core.CremeEntity']))
        db.alter_column('creme_core_relation', 'object_entity_id',  self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['creme_core.CremeEntity']))

        # Changing field 'HistoryLine.entity'
        db.alter_column('creme_core_historyline', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['creme_core.CremeEntity'], null=True, on_delete=models.SET_NULL))
    ...
    def backwards(self, orm):
        ...
        #These FK add already these 'on_delete' attributes in 1.2 version...
        ## Changing Relation fields 'subject_entity' & 'object_entity'
        #db.alter_column('creme_core_relation', 'subject_entity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['creme_core.CremeEntity']))
        #db.alter_column('creme_core_relation', 'object_entity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['creme_core.CremeEntity']))

        ## Changing field 'HistoryLine.entity'
        #db.alter_column('creme_core_historyline', 'entity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['creme_core.CremeEntity'], null=True))
