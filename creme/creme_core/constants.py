...
# SETTING_BLOCK_DEFAULT_STATE_IS_OPEN           = SETTING_BRICK_DEFAULT_STATE_IS_OPEN
# SETTING_BLOCK_DEFAULT_STATE_SHOW_EMPTY_FIELDS = SETTING_BRICK_DEFAULT_STATE_SHOW_EMPTY_FIELDS
...
MODELBLOCK_ID = MODELBRICK_ID  # DEPRECATED
