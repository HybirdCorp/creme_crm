...
class WorkflowRegistry:
    ...
    #     fields = []
    #     for source in root_sources:
    #         field =  source.config_formfield(user=user)
    #         (source.config_formfield_kind_id, field)
    #
    ...
    def action_source_formfields(self,
                                 root_sources: Iterable[WorkflowActionSource],
                                 user: CremeUser,
                                 ) -> list[FormField]:  # TODO: FormField with kind_id...
        # TODO: check that root source classes are registered?
        # fields = [
        #     # (source.type_id, source.config_formfield(user=user))
        ...
        #     for source in root_sources
        # ]
        fields = [source.config_formfield(user=user) for source in root_sources]
