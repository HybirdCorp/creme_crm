...
# ------------------------------------------------------------------------------
# TODO: unit test
# TODO: make immutable (use dataclass?) + keyword only
class QuerySortInfo:
    ...
    It contains 4 attributes:
        ...
        - annotations: dictionary containing ORM annotations (see 'QuerySet.annotate()')
          which must be used in the QuerySet we want to sort (i.e. 'field_names' is
          referencing some annotations).
    """
