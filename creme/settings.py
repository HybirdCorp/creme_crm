...
# STATICS PIPELINE & THEME SETTINGS [END] #############################################
...
STATIC_CORE_ROOT = join(CREME_ROOT, "static")
STATIC_ROOT = join(CREME_ROOT, 'collected_statics')
...
class LazyFilteredList:
    def __init__(self, *values):
        self.values = [(requirement, staticfile) for (requirement, staticfile) in values]

    def __iter__(self):
        from django.conf import settings
        return iter((
            staticfile
            for (requirement, staticfile) in self.values
            if requirement is None or requirement in settings.INSTALLED_APPS
        ))

# TODO: create a static/css/creme-minimal.css for login/logout ??
PIPELINE = {
    # When debug=True, do not collect statics in STATIC_ROOT:
    'PIPELINE_COLLECTOR_ENABLED': False,
    'STYLESHEETS': {
        'main.chantilly': {
            'source_filenames': LazyFilteredList(
                ('creme.creme_core', 'chantilly/creme_core/css/jquery-css/creme-theme/jquery-ui-1.11.4.custom.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/jqplot-1.0.8/jquery.jqplot.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/jquery.gccolor.1.0.3/gccolor.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/chosen/chosen-0.9.15-unchosen.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/creme.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/creme-ui.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/header_menu.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/forms.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/blocks.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/bricks.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/home.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/my_page.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/list_view.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/detail_view.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/search_results.css'),
                ('creme.creme_core', 'chantilly/creme_core/css/popover.css'),
                ('creme.creme_config', 'chantilly/creme_config/css/creme_config.css'),
                ('creme.persons', 'chantilly/persons/css/persons.css'),
                ('creme.activities', 'chantilly/activities/css/activities.css'),
                ('creme.activities', 'chantilly/activities/css/fullcalendar-3.10.0.css'),
                ('creme.billing', 'chantilly/billing/css/billing.css'),
                ('creme.opportunities', 'chantilly/opportunities/css/opportunities.css'),
                ('creme.commercial', 'chantilly/commercial/css/commercial.css'),
                ('creme.crudity', 'chantilly/crudity/css/crudity.css'),
                ('creme.emails', 'chantilly/emails/css/emails.css'),
                ('creme.geolocation', 'chantilly/geolocation/css/geolocation.css'),
                ('creme.polls', 'chantilly/polls/css/polls.css'),
                ('creme.products', 'chantilly/products/css/products.css'),
                ('creme.projects', 'chantilly/projects/css/projects.css'),
                ('creme.reports', 'chantilly/reports/css/reports.css'),
                ('creme.tickets', 'chantilly/tickets/css/tickets.css'),
                ('creme.mobile', 'chantilly/mobile/css/mobile.css'),
                ('creme.cti', 'chantilly/cti/css/cti.css'),
            ),
            'output_filename': 'chantilly/main.css',
        },
        'main.icecream': {
            'source_filenames': LazyFilteredList(
                ('creme.creme_core', 'icecream/creme_core/css/jquery-css/creme-theme/jquery-ui-1.11.4.custom.css'),
                ('creme.creme_core', 'icecream/creme_core/css/jqplot-1.0.8/jquery.jqplot.css'),
                ('creme.creme_core', 'icecream/creme_core/css/jquery.gccolor.1.0.3/gccolor.css'),
                ('creme.creme_core', 'icecream/creme_core/css/chosen/chosen-0.9.15-unchosen.css'),
                ('creme.creme_core', 'icecream/creme_core/css/creme.css'),
                ('creme.creme_core', 'icecream/creme_core/css/creme-ui.css'),
                ('creme.creme_core', 'icecream/creme_core/css/header_menu.css'),
                ('creme.creme_core', 'icecream/creme_core/css/forms.css'),
                ('creme.creme_core', 'icecream/creme_core/css/blocks.css'),
                ('creme.creme_core', 'icecream/creme_core/css/bricks.css'),
                ('creme.creme_core', 'icecream/creme_core/css/home.css'),
                ('creme.creme_core', 'icecream/creme_core/css/my_page.css'),
                ('creme.creme_core', 'icecream/creme_core/css/list_view.css'),
                ('creme.creme_core', 'icecream/creme_core/css/detail_view.css'),
                ('creme.creme_core', 'icecream/creme_core/css/search_results.css'),
                ('creme.creme_core', 'icecream/creme_core/css/popover.css'),
                ('creme.creme_config', 'icecream/creme_config/css/creme_config.css'),
                ('creme.persons', 'icecream/persons/css/persons.css'),
                ('creme.activities', 'icecream/activities/css/activities.css'),
                ('creme.activities', 'icecream/activities/css/fullcalendar-3.10.0.css'),
                ('creme.billing', 'icecream/billing/css/billing.css'),
                ('creme.opportunities', 'icecream/opportunities/css/opportunities.css'),
                ('creme.commercial', 'icecream/commercial/css/commercial.css'),
                ('creme.crudity', 'icecream/crudity/css/crudity.css'),
                ('creme.emails', 'icecream/emails/css/emails.css'),
                ('creme.geolocation', 'icecream/geolocation/css/geolocation.css'),
                ('creme.polls', 'icecream/polls/css/polls.css'),
                ('creme.products', 'icecream/products/css/products.css'),
                ('creme.projects', 'icecream/projects/css/projects.css'),
                ('creme.reports', 'icecream/reports/css/reports.css'),
                ('creme.tickets', 'icecream/tickets/css/tickets.css'),
                ('creme.mobile', 'icecream/mobile/css/mobile.css'),
                ('creme.cti', 'icecream/cti/css/cti.css'),
            ),
            'output_filename': 'icecream/main.css',
        },
    },
    'JAVASCRIPT': {
        'i18n.fr': {
            ...
            'output_filename': 'js/fr-FR.js',
        },
        'i18n.en': {
            'source_filenames': [
                'en.js',
            ],
            'output_filename': 'js/en-US.js',
        },
        'libs': {
            'source_filenames': LazyFilteredList(
                ('creme.creme_core', 'creme_core/js/media.js'),
                ('creme.creme_core', 'creme_core/js/jquery/jquery-1.11.2.js'),
                ('creme.creme_core', 'creme_core/js/jquery/jquery-migrate-1.2.1.js'),
                ('creme.creme_core', 'creme_core/js/jquery/ui/jquery-ui-1.11.4.custom.js'),
                ('creme.creme_core', 'creme_core/js/jquery/ui/jquery-ui-locale.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jquery.browser.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jquery.uuid-2.0.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/excanvas.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/jquery.jqplot.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.enhancedLegendRenderer.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.canvasTextRenderer.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.categoryAxisRenderer.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.canvasTextRenderer.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.canvasAxisLabelRenderer.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.canvasAxisTickRenderer.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.pieRenderer.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.donutRenderer.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.barRenderer.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.pointLabels.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.highlighter.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jqplot-1.0.8/plugins/jqplot.cursor.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/cookie.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/gccolor-1.0.3.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/json-2.2.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/highlight.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/utils.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/wait.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jquery.dragtable.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jquery.form-3.51.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jquery.tinymce.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jquery.debounce.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/chosen.jquery-0.9.15-unchosen.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jquery.bind-first.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jquery.floatthead-1.3.1._.js'),
                ('creme.creme_core', 'creme_core/js/jquery/extensions/jquery.floatthead-1.3.1.js'),
                ('creme.creme_core', 'creme_core/js/lib/momentjs/moment-2.24.0.js'),
                ('creme.creme_core', 'creme_core/js/lib/momentjs/locale/en-us.js'),
                ('creme.creme_core', 'creme_core/js/lib/momentjs/locale/fr-fr.js'),
        ...
        'main': {
            'source_filenames': LazyFilteredList(
                ('creme.creme_core', 'creme_core/js/lib/fallbacks/object-0.1.js'),
                ('creme.creme_core', 'creme_core/js/lib/fallbacks/array-0.9.js'),
                ('creme.creme_core', 'creme_core/js/lib/fallbacks/string-0.1.js'),
                ('creme.creme_core', 'creme_core/js/lib/fallbacks/console.js'),
                ('creme.creme_core', 'creme_core/js/lib/fallbacks/event-0.1.js'),
                ('creme.creme_core', 'creme_core/js/lib/fallbacks/htmldocument-0.1.js'),
                ('creme.creme_core', 'creme_core/js/lib/generators-0.1.js'),
                ('creme.creme_core', 'creme_core/js/lib/color.js'),
                ('creme.creme_core', 'creme_core/js/lib/assert.js'),
                ('creme.creme_core', 'creme_core/js/lib/faker.js'),
                ('creme.creme_core', 'creme_core/js/lib/browser.js'),
                ('creme.creme_core', 'creme_core/js/creme.js'),
                ('creme.creme_core', 'creme_core/js/color.js'),
                ('creme.creme_core', 'creme_core/js/utils.js'),
                ('creme.creme_core', 'creme_core/js/forms.js'),
                ('creme.creme_core', 'creme_core/js/ajax.js'),
                ('creme.creme_core', 'creme_core/js/widgets/base.js'),
                ('creme.creme_core', 'creme_core/js/widgets/component/component.js'),
                ('creme.creme_core', 'creme_core/js/widgets/component/factory.js'),
                ('creme.creme_core', 'creme_core/js/widgets/component/events.js'),
                ('creme.creme_core', 'creme_core/js/widgets/component/action.js'),
                ('creme.creme_core', 'creme_core/js/widgets/component/action-registry.js'),
                ('creme.creme_core', 'creme_core/js/widgets/component/action-link.js'),
                ('creme.creme_core', 'creme_core/js/widgets/component/chosen.js'),
                ('creme.creme_core', 'creme_core/js/widgets/utils/template.js'),
                ('creme.creme_core', 'creme_core/js/widgets/utils/lambda.js'),
                ('creme.creme_core', 'creme_core/js/widgets/utils/converter.js'),
                ('creme.creme_core', 'creme_core/js/widgets/utils/json.js'),
                ('creme.creme_core', 'creme_core/js/widgets/utils/compare.js'),
                ('creme.creme_core', 'creme_core/js/widgets/utils/history.js'),
                ('creme.creme_core', 'creme_core/js/widgets/utils/plugin.js'),
                ('creme.creme_core', 'creme_core/js/widgets/ajax/url.js'),
                ('creme.creme_core', 'creme_core/js/widgets/ajax/backend.js'),
                ('creme.creme_core', 'creme_core/js/widgets/ajax/mockbackend.js'),
                ('creme.creme_core', 'creme_core/js/widgets/ajax/cachebackend.js'),
                ('creme.creme_core', 'creme_core/js/widgets/ajax/query.js'),
                ('creme.creme_core', 'creme_core/js/widgets/layout/layout.js'),
                ('creme.creme_core', 'creme_core/js/widgets/layout/sortlayout.js'),
                ('creme.creme_core', 'creme_core/js/widgets/layout/columnlayout.js'),
                ('creme.creme_core', 'creme_core/js/widgets/layout/autosize.js'),
                ('creme.creme_core', 'creme_core/js/widgets/model/collection.js'),
                ('creme.creme_core', 'creme_core/js/widgets/model/array.js'),
                ('creme.creme_core', 'creme_core/js/widgets/model/renderer.js'),
                ('creme.creme_core', 'creme_core/js/widgets/model/query.js'),
                ('creme.creme_core', 'creme_core/js/widgets/model/controller.js'),
                ('creme.creme_core', 'creme_core/js/widgets/model/choice.js'),
                ('creme.creme_core', 'creme_core/js/widgets/dialog/dialog.js'),
                ('creme.creme_core', 'creme_core/js/widgets/dialog/overlay.js'),
                ('creme.creme_core', 'creme_core/js/widgets/dialog/frame.js'),
                ('creme.creme_core', 'creme_core/js/widgets/dialog/confirm.js'),
                ('creme.creme_core', 'creme_core/js/widgets/dialog/form.js'),
                ('creme.creme_core', 'creme_core/js/widgets/dialog/select.js'),
                ('creme.creme_core', 'creme_core/js/widgets/dialog/glasspane.js'),
                ('creme.creme_core', 'creme_core/js/widgets/dialog/popover.js'),
                ('creme.creme_core', 'creme_core/js/widgets/list/pager.js'),
                ('creme.creme_core', 'creme_core/js/widgets/frame.js'),
                ('creme.creme_core', 'creme_core/js/widgets/toggle.js'),
                ('creme.creme_core', 'creme_core/js/widgets/pluginlauncher.js'),
                ('creme.creme_core', 'creme_core/js/widgets/dinput.js'),
                ('creme.creme_core', 'creme_core/js/widgets/dselect.js'),
                ('creme.creme_core', 'creme_core/js/widgets/checklistselect.js'),
                ('creme.creme_core', 'creme_core/js/widgets/datetime.js'),
                ('creme.creme_core', 'creme_core/js/widgets/daterange.js'),
                ('creme.creme_core', 'creme_core/js/widgets/daterangeselector.js'),
                ('creme.creme_core', 'creme_core/js/widgets/chainedselect.js'),
                ('creme.creme_core', 'creme_core/js/widgets/selectorlist.js'),
                ('creme.creme_core', 'creme_core/js/widgets/entityselector.js'),
                ('creme.creme_core', 'creme_core/js/widgets/pselect.js'),
                ('creme.creme_core', 'creme_core/js/widgets/actionlist.js'),
                ('creme.creme_core', 'creme_core/js/widgets/plotdata.js'),
                ('creme.creme_core', 'creme_core/js/widgets/plot.js'),
                ('creme.creme_core', 'creme_core/js/widgets/plotselector.js'),
                ('creme.creme_core', 'creme_core/js/widgets/scrollactivator.js'),
                ('creme.creme_core', 'creme_core/js/widgets/container.js'),
                ('creme.creme_core', 'creme_core/js/menu.js'),
                ('creme.creme_core', 'creme_core/js/search.js'),
                ('creme.creme_core', 'creme_core/js/bricks.js'),
                ('creme.creme_core', 'creme_core/js/bricks-action.js'),
                ('creme.creme_core', 'creme_core/js/list_view.core.js'),
                ('creme.creme_core', 'creme_core/js/lv_widget.js'),
                ('creme.creme_core', 'creme_core/js/detailview.js'),
                ('creme.creme_core', 'creme_core/js/entity_cell.js'),
                ('creme.creme_core', 'creme_core/js/export.js'),
                ('creme.creme_core', 'creme_core/js/merge.js'),
                ('creme.creme_core', 'creme_core/js/relations.js'),
                ('creme.creme_core', 'creme_core/js/jobs.js'),
        ...
        'testlib': {
            ...
            'output_filename': 'tests/testlib.js',
        },
        'tests': {
            'source_filenames': LazyFilteredList(
                ('creme.creme_core', 'creme_core/js/tests/component/component.js'),
                ('creme.creme_core', 'creme_core/js/tests/component/events.js'),
                ('creme.creme_core', 'creme_core/js/tests/component/action.js'),
                ('creme.creme_core', 'creme_core/js/tests/component/actionregistry.js'),
                ('creme.creme_core', 'creme_core/js/tests/component/actionlink.js'),
                ('creme.creme_core', 'creme_core/js/tests/component/chosen.js'),
                ('creme.creme_core', 'creme_core/js/tests/utils/template.js'),
                ('creme.creme_core', 'creme_core/js/tests/utils/lambda.js'),
                ('creme.creme_core', 'creme_core/js/tests/utils/converter.js'),
                ('creme.creme_core', 'creme_core/js/tests/utils/utils.js'),
                ('creme.creme_core', 'creme_core/js/tests/utils/plugin.js'),
                ('creme.creme_core', 'creme_core/js/tests/ajax/mockajax.js'),
                ('creme.creme_core', 'creme_core/js/tests/ajax/cacheajax.js'),
                ('creme.creme_core', 'creme_core/js/tests/ajax/query.js'),
                ('creme.creme_core', 'creme_core/js/tests/ajax/localize.js'),
                ('creme.creme_core', 'creme_core/js/tests/ajax/utils.js'),
                ('creme.creme_core', 'creme_core/js/tests/model/collection.js'),
                ('creme.creme_core', 'creme_core/js/tests/model/renderer-list.js'),
                ('creme.creme_core', 'creme_core/js/tests/model/renderer-choice.js'),
                ('creme.creme_core', 'creme_core/js/tests/model/renderer-checklist.js'),
                ('creme.creme_core', 'creme_core/js/tests/model/query.js'),
                ('creme.creme_core', 'creme_core/js/tests/model/controller.js'),
                ('creme.creme_core', 'creme_core/js/tests/dialog/frame.js'),
                ('creme.creme_core', 'creme_core/js/tests/dialog/overlay.js'),
                ('creme.creme_core', 'creme_core/js/tests/dialog/dialog.js'),
                ('creme.creme_core', 'creme_core/js/tests/dialog/dialog-form.js'),
                ('creme.creme_core', 'creme_core/js/tests/dialog/popover.js'),
                ('creme.creme_core', 'creme_core/js/tests/dialog/glasspane.js'),
                ('creme.creme_core', 'creme_core/js/tests/fallbacks.js'),
                ('creme.creme_core', 'creme_core/js/tests/generators.js'),
                ('creme.creme_core', 'creme_core/js/tests/color.js'),
                ('creme.creme_core', 'creme_core/js/tests/assert.js'),
                ('creme.creme_core', 'creme_core/js/tests/faker.js'),
                ('creme.creme_core', 'creme_core/js/tests/browser.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/base.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/widget.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/plot.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/frame.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/toggle.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/dselect.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/dinput.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/pselect.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/entityselector.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/chainedselect.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/checklistselect.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/selectorlist.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/actionlist.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/plotselector.js'),
                ('creme.creme_core', 'creme_core/js/tests/widgets/entitycells.js'),
                ('creme.creme_core', 'creme_core/js/tests/form/forms.js'),
                ('creme.creme_core', 'creme_core/js/tests/list/list-pager.js'),
                ('creme.creme_core', 'creme_core/js/tests/list/listview-actions.js'),
                ('creme.creme_core', 'creme_core/js/tests/list/listview-header.js'),
                ('creme.creme_core', 'creme_core/js/tests/list/listview-core.js'),
                ('creme.creme_core', 'creme_core/js/tests/list/listview-dialog.js'),
                ('creme.creme_core', 'creme_core/js/tests/brick/brick.js'),
                ('creme.creme_core', 'creme_core/js/tests/brick/brick-actions.js'),
                ('creme.creme_core', 'creme_core/js/tests/brick/brick-menu.js'),
                ('creme.creme_core', 'creme_core/js/tests/brick/brick-table.js'),
                ('creme.creme_core', 'creme_core/js/tests/brick/dependencies.js'),
                ('creme.creme_core', 'creme_core/js/tests/views/detailview-actions.js'),
                ('creme.creme_core', 'creme_core/js/tests/views/hatmenubar.js'),
                ('creme.creme_core', 'creme_core/js/tests/views/menu.js'),
                ('creme.creme_core', 'creme_core/js/tests/views/search.js'),
                ('creme.creme_core', 'creme_core/js/tests/views/utils.js'),
            ...
            'output_filename': 'tests/tests.js',
        },
    },
    'JS_COMPRESSOR': 'pipeline.compressors.closure.ClosureCompressor',
    'CLOSURE_BINARY': "java -jar " + join(
        STATIC_CORE_ROOT, 'utils', 'closure', 'closure-compiler-v20200112.jar',
    ),
    'CSS_COMPRESSOR': 'pipeline.compressors.yui.YUICompressor',
    'YUI_BINARY': "java -jar " + join(
        STATIC_CORE_ROOT, 'utils', 'yui', 'yuicompressor-2.4.2.jar',
    ),
}
