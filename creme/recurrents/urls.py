...
if not rgenerator_model_is_custom():
    ...
    urlpatterns += [
        ...
        url(r'^generator/edit/(?P<generator_id>\d+)[/]?$', recurrentgenerator.RecurrentGeneratorEdition.as_view(),
        ...
        url(r'^generator/(?P<generator_id>\d+)[/]?$', recurrentgenerator.RecurrentGeneratorDetail.as_view(),
