...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'RecurrentGenerator.periodicity_json'
        db.add_column('recurrents_recurrentgenerator', 'periodicity_json',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False,
                     )

        # Useless we are going to remove this field....
        ## Changing field 'RecurrentGenerator.periodicity'
        #db.alter_column('recurrents_recurrentgenerator', 'periodicity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recurrents.Periodicity'], on_delete=models.PROTECT))

        now_value = now()
        # Changing field 'RecurrentGenerator.last_generation'
        #db.alter_column('recurrents_recurrentgenerator', 'last_generation', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 8, 0, 0)))
        db.alter_column('recurrents_recurrentgenerator', 'last_generation',
                        self.gf('django.db.models.fields.DateTimeField')(default=now_value),
                       )

        # Changing field 'RecurrentGenerator.first_generation'
        #db.alter_column('recurrents_recurrentgenerator', 'first_generation', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 8, 0, 0)))
        db.alter_column('recurrents_recurrentgenerator', 'first_generation',
                        self.gf('django.db.models.fields.DateTimeField')(default=now_value),
                       )

    def backwards(self, orm):
        # Deleting field 'RecurrentGenerator.periodicity_json'
        db.delete_column('recurrents_recurrentgenerator', 'periodicity_json')

        # See below
        ## Changing field 'RecurrentGenerator.periodicity'
        #db.alter_column('recurrents_recurrentgenerator', 'periodicity_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['recurrents.Periodicity']))
