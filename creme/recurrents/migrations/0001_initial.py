    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_generation', models.DateTimeField(verbose_name='Date of the first recurrent generation')),
                ('last_generation', models.DateTimeField(verbose_name='Date of the last recurrent generation', null=True, editable=False)),
