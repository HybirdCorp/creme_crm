...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'RecurrentGenerator.last_generation'
        raise RuntimeError("Cannot reverse this migration. 'RecurrentGenerator.last_generation' and its values cannot be restored.")
