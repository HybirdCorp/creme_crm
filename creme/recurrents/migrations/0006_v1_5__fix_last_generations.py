...
class Migration(DataMigration):
    def forwards(self, orm):
        orm['recurrents.RecurrentGenerator'].objects \
                                            .filter(first_generation=F('last_generation')) \
                                            .update(last_generation=None)

    def backwards(self, orm):
        orm['recurrents.RecurrentGenerator'].objects \
                                            .filter(last_generation__isnull=True) \
                                            .update(last_generation=F('first_generation'))
    ...
    models = {
        ...
        'recurrents.recurrentgenerator': {
            ...
            'last_generation': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
