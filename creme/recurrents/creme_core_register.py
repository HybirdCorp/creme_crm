...
reg_item(reverse('recurrents__create_generator'), RecurrentGenerator.creation_label, build_creation_perm(RecurrentGenerator))
...
bulk_update_registry.register(RecurrentGenerator, exclude=['first_generation'])
