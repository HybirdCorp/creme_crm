...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('media_managers', ['MediaCategory'])

        # Adding model 'Image'
        db.create_table('media_managers_image', (
            ...
            ('height', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ...
        db.send_create_signal('media_managers', ['Image'])

        # Adding M2M table for field categories on 'Image'
        db.create_table('media_managers_image_categories', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('image', models.ForeignKey(orm['media_managers.image'], null=False)),
            ('mediacategory', models.ForeignKey(orm['media_managers.mediacategory'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('media_managers_image')
