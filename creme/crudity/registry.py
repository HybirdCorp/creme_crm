...
#                     )
#
#                 register_fetchers(source_type, [fetcher_cls() for fetcher_cls
#                 in fetchers_classes])
#
#             # Inputs
...
class NEWCRUDityRegistry:
    ...
    # TODO: register ONE model & its specificity (e.g how to manage Address)
    def register(self, *models):
        self._models.update(models)


NEW_crudity_registry = NEWCRUDityRegistry()
