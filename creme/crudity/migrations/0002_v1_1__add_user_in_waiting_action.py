...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaitingAction.user'
        db.add_column('crudity_waitingaction', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'History.user'
        db.add_column('crudity_history', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WaitingAction.user'
        db.delete_column('crudity_waitingaction', 'user_id')

        # Deleting field 'History.user'
        db.delete_column('crudity_history', 'user_id')
