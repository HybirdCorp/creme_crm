...
#         cat21 = SubCategory.objects.create(name='sub21',
#            description='description', category=cat2)
#
#         with self.assertNumQueries(0):
...
#         cat1 = Category.objects.create(name='cat1', description='description')
#         cat11 = SubCategory.objects.create(name='sub11',
#           description='description', category=cat1)
#
