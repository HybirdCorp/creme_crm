...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MobileFavorite'
        db.create_table('mobile_mobilefavorite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mobile_favorite', to=orm['creme_core.CremeEntity'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mobile_favorite', to=orm['auth.User'])),
        ))
        db.send_create_signal('mobile', ['MobileFavorite'])

    def backwards(self, orm):
        # Deleting model 'MobileFavorite'
        db.delete_table('mobile_mobilefavorite')
    ...
    models = {
        ...
        'mobile.mobilefavorite': {
            'Meta': {'object_name': 'MobileFavorite'},
            'entity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mobile_favorite'", 'to': "orm['creme_core.CremeEntity']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mobile_favorite'", 'to': "orm['auth.User']"})
        }
    }
