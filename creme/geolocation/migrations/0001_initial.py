...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('geolocation_geoaddress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('address', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['persons.Address'], unique=True)),
        ...
        db.send_create_signal('geolocation', ['GeoAddress'])

        # Adding model 'Town'
        db.create_table('geolocation_town', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('geolocation', ['Town'])


    def backwards(self, orm):
        # Deleting model 'GeoAddress'
        db.delete_table('geolocation_geoaddress')

        # Deleting model 'Town'
        db.delete_table('geolocation_town')
