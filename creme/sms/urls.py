...
urlpatterns = [
    ...
    re_path(r'^campaign/sending/delete[/]?$',                   sending.delete,                    name='sms__delete_sending'),

    # Campaign: sending details brick
    re_path(r'^campaign/sending/(?P<id>\d+)[/]?$',                 sending.Messages.as_view(),    name='sms__view_sending'),
    ...
    re_path(r'^messaging_list/(?P<mlist_id>\d+)/recipient/add_csv[/]?$', recipient.RecipientsAddingFromCSV.as_view(), name='sms__add_recipients_from_csv'),
