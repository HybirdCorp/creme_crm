...
$child.animate(opts.fx,fxDuration,"swing",opts.onAfterExpand);}else{if(bExpand)
$child.show(opts.onAfterExpand);else
$child.hide(opts.onAfterExpand);}}
if(opts.onExpand)
