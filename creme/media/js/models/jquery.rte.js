    ...
    return this.each( function() {
        ...
        function toolbar() {
            var tb = $("<div class='rte-toolbar' id='toolbar-"+ element_id +"'><div>\
                ...
                <p>\
                    <a href='#' class='bold'><img src='"+opts.media_url+"rte/bold.gif' alt='bold' title='bold' /></a>\
                    <a href='#' class='italic'><img src='"+opts.media_url+"rte/italic.gif' alt='italic' title='italic' /></a>\
                </p>\
                <p>\
                    <a href='#' class='unorderedlist'><img src='"+opts.media_url+"rte/unordered.gif' alt='unordered list' title='unordered list' /></a>\
                    <a href='#' class='link'><img src='"+opts.media_url+"web_22.png' alt='link' title='link'/></a>\
                    <a href='#' class='image'><img src='"+opts.media_url+"image_22.png' alt='image' title='image' /></a>\
                    <a href='#' class='disable'><img src='"+opts.media_url+"cancel_22.png' alt='close rte' title='close rich text editor'/></a>\
                    <a href='#' class='word'><img src='"+opts.media_url+"document_doc_22.png' alt='word' title='from word'/></a>\
                </p></div></div>");
