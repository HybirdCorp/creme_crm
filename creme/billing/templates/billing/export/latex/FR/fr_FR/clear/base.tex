{% autoescape off %}
{% load creme_core_tags creme_ctype creme_latex %}
...
{% if object.target.entity_type == 'PERSONS_ORGANISATION_MODEL'|ctype_for_swappable %}& Numéro TVA: {{object.target.tvaintra|default:'-'}} \\{% endif %}
 & {{billing_address.address|latex_escape}} \\
 & {{billing_address.city|latex_escape}} {{billing_address.po_box|latex_escape}} \\
\end{tabular}
{% endblock %}
