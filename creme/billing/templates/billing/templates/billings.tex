...
\def\TargetAddress{%
{{target.billing_address.address|safe}} \\
{{target.billing_address.city|safe}} {{target.billing_address.po_box|safe}} \\
}
...
\multicolumn{2}{c|} {} & \centering{ Total HT } & \centering{ {{object.get_total}} Euros } \tabularnewline \cline{3-4}
\multicolumn{2}{c|} {} & \centering{ TVA } & \centering{ {{object.get_total_with_tax|sub:object.get_total}} Euros } \tabularnewline \cline{3-4}
\multicolumn{2}{c|} {} & \centering{ TTC } & \centering{ {{object.get_total_with_tax}} Euros } \tabularnewline \cline{3-4}
\endlastfoot
   
{% for line in plines %}
   \hline
    {% if line.related_item %} \centering{ {{line.related_item}} } {% else %} \centering{ {{line.on_the_fly_item}} } {% endif %} & \centering{ {{line.quantity}} } &  \centering{ {{line.unit_price}} } & \centering{ {{line.quantity|mult:line.unit_price}} } \tabularnewline
   \hline
{% endfor %}
