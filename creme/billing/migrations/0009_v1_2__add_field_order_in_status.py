...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'SalesOrderStatus.order'
        db.add_column('billing_salesorderstatus', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'InvoiceStatus.order'
        db.add_column('billing_invoicestatus', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'QuoteStatus.order'
        db.add_column('billing_quotestatus', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

        # Adding field 'CreditNoteStatus.order'
        db.add_column('billing_creditnotestatus', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SalesOrderStatus.order'
        db.delete_column('billing_salesorderstatus', 'order')

        # Deleting field 'InvoiceStatus.order'
        db.delete_column('billing_invoicestatus', 'order')

        # Deleting field 'QuoteStatus.order'
        db.delete_column('billing_quotestatus', 'order')

        # Deleting field 'CreditNoteStatus.order'
        db.delete_column('billing_creditnotestatus', 'order')
