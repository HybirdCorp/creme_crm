...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Line.vat'
        db.delete_column('billing_line', 'vat')

        # Renaming field 'Line.vat_value' into 'Line.vat'
#        db.rename_column('billing_line', 'vat_value', 'vat')
...
#        db.delete_column('billing_line', 'vat')
        ...
        # Adding field 'Line.vat'
        db.add_column('billing_line', 'vat', self.gf('django.db.models.fields.DecimalField')(default='19.6', max_digits=4, decimal_places=2), keep_default=False)
