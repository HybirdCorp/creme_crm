...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm['contenttypes.ContentType'].objects.filter(app_label='billing', model='vat').update(app_label='creme_core')

    def backwards(self, orm):
        orm['contenttypes.ContentType'].objects.filter(app_label='creme_core', model='vat').update(app_label='billing')
