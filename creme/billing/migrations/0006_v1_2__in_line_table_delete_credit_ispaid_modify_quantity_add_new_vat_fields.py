...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Line.is_paid'
        db.delete_column('billing_line', 'is_paid')

        # Deleting field 'Line.credit'
        db.delete_column('billing_line', 'credit')

        # Adding field 'Line.vat_value'
        db.add_column('billing_line', 'vat_value', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['billing.Vat'], null=True, blank=True), keep_default=False)

        # Changing field 'Line.quantity'
        db.alter_column('billing_line', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Line.is_paid'
        db.add_column('billing_line', 'is_paid', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Line.credit'
        db.add_column('billing_line', 'credit', self.gf('django.db.models.fields.DecimalField')(default='0', max_digits=10, decimal_places=2), keep_default=False)

        # Deleting field 'Line.vat_value'
        db.delete_column('billing_line', 'vat_value_id')

        # Changing field 'Line.quantity'
        db.alter_column('billing_line', 'quantity', self.gf('django.db.models.fields.IntegerField')())
