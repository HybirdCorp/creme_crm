...
class Migration(DataMigration):
    status_models = ('billing.creditnotestatus',
    ...
    def forwards(self, orm):
        for model in self.status_models:
            for i, instance in enumerate(orm[model].objects.order_by('order'), start=1):
                if i != instance.order:
                    instance.order = i
                    instance.save()
    ...
    def backwards(self, orm):
        #for model in self.models:
            #orm[model].objects.update(order=1)
        pass
