...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Base.comment'
        db.alter_column('billing_base', 'comment', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        # Changing field 'Base.comment'
        db.alter_column('billing_base', 'comment', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
