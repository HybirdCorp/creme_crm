...
urlpatterns += swap_manager.add_group(
    ...
    Swappable(url(r'^folders[/]?$',                             folder.FoldersList.as_view(),         name='documents__list_folders')),
...
urlpatterns += swap_manager.add_group(
    ...
    Swappable(url(r'^documents[/]?$',                              document.DocumentsList.as_view(),           name='documents__list_documents')),
