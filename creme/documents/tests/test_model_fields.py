...
class ImageFieldsTestCase(_DocumentsTestCase):
    def test_build_limit_choices_to__q(self):
    ...
    def test_build_limit_choices_to__dict(self):
    ...
    def test_deconstruct_limit_choices_to__q(self):
        q1 = Q(mime_type__name__startswith=MIMETYPE_PREFIX_IMG)
    ...
    def test_deconstruct_limit_choices_to__dict(self):
