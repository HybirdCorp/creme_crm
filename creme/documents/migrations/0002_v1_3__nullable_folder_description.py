...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Folder.description'
        db.alter_column('documents_folder', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Changing field 'Folder.description'
        db.alter_column('documents_folder', 'description', self.gf('django.db.models.fields.TextField')(default='**Insert description here**'))
