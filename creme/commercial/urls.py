...
urlpatterns = [
    ...
    re_path(r'^market_segment/add[/]?$',                        market_segment.SegmentCreation.as_view(), name='commercial__create_segment'),
    re_path(r'^market_segment/edit/(?P<segment_id>\d+)[/]?$',   market_segment.SegmentEdition.as_view(),  name='commercial__edit_segment'),
    re_path(r'^market_segment/delete/(?P<segment_id>\d+)[/]?$', market_segment.SegmentDeletion.as_view(), name='commercial__delete_segment'),

    # Objectives & opportunities
    re_path(r'^act/(?P<act_id>\d+)/add/objective[/]?$',               act.ObjectiveCreation.as_view(),             name='commercial__create_objective'),
    re_path(r'^act/(?P<act_id>\d+)/add/objectives_from_pattern[/]?$', act.ObjectivesCreationFromPattern.as_view(), name='commercial__create_objective_from_pattern'),  # TODO: commercial__create_objectiveS_from_pattern
    re_path(r'^objective/(?P<objective_id>\d+)/edit[/]?$',            act.ObjectiveEdition.as_view(),              name='commercial__edit_objective'),
    re_path(r'^objective/(?P<objective_id>\d+)/incr[/]?$',            act.incr_objective_counter,                  name='commercial__incr_objective_counter'),
    re_path(r'^objective/(?P<objective_id>\d+)/create_entity[/]?$',   act.RelatedEntityCreation.as_view(),         name='commercial__create_entity_from_objective'),

    # Pattern component
    re_path(r'^objective_pattern/(?P<objpattern_id>\d+)/add_component[/]?$',      act.PatternComponentCreation.as_view(),       name='commercial__create_component'),
    re_path(r'^objective_pattern/component/(?P<component_id>\d+)/add_child[/]$',  act.ChildPatternComponentCreation.as_view(),  name='commercial__create_child_component'),
    re_path(r'^objective_pattern/component/(?P<component_id>\d+)/add_parent[/]$', act.ParentPatternComponentCreation.as_view(), name='commercial__create_parent_component'),

    # Segments
    re_path(r'^strategy/(?P<strategy_id>\d+)/add/segment[/]?$',  strategy.SegmentDescCreation.as_view(), name='commercial__create_segment_desc'),
    re_path(r'^strategy/(?P<strategy_id>\d+)/link/segment[/]?$', strategy.SegmentLinking.as_view(),      name='commercial__link_segment'),
    re_path(r'^segment_desc/edit/(?P<segdesc_id>\d+)[/]?$',      strategy.SegmentDescEdition.as_view(),  name='commercial__edit_segment_desc'),

    # Assets
    re_path(r'^strategy/(?P<strategy_id>\d+)/add/asset[/]?$', strategy.AssetCreation.as_view(), name='commercial__create_asset'),
    re_path(r'^asset/edit/(?P<asset_id>\d+)[/]?$',            strategy.AssetEdition.as_view(),  name='commercial__edit_asset'),

    # Charms
    re_path(r'^strategy/(?P<strategy_id>\d+)/add/charm[/]?$', strategy.CharmCreation.as_view(), name='commercial__create_charm'),
    ...
    # Bricks reloading
    re_path(r'^bricks/reload/matrix/(?P<strategy_id>\d+)/(?P<orga_id>\d+)[/]?$', strategy.reload_matrix_brick, name='commercial__reload_matrix_brick'),
]
...
urlpatterns += swap_manager.add_group(
    ...
    Swappable(re_path(r'^act/(?P<act_id>\d+)[/]?$',      act.ActDetail.as_view(),   name='commercial__view_act'), check_args=Swappable.INT_ID),
    app_name='commercial',
).kept_patterns()
...
urlpatterns += swap_manager.add_group(
    ...
    Swappable(re_path(r'^objective_pattern/(?P<objpattern_id>\d+)[/]?$',      act.ActObjectivePatternDetail.as_view(),   name='commercial__view_pattern'), check_args=Swappable.INT_ID),
    app_name='commercial',
).kept_patterns()
...
urlpatterns += swap_manager.add_group(
    ...
    Swappable(re_path(r'^strategy/(?P<strategy_id>\d+)[/]?$',      strategy.StrategyDetail.as_view(),   name='commercial__view_strategy'), check_args=Swappable.INT_ID),
    app_name='commercial',
).kept_patterns()
