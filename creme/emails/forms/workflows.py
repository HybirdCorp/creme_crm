...
class ActionRecipientField(core_fields.UnionField):
    def __init__(self, trigger=None, user=None, registry=recipients_registry, **kwargs):
...
class EmailSendingActionForm(core_wf_forms.BaseWorkflowActionForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        fields = self.fields
        fields['recipient'].trigger = fields['source'].trigger = self.instance.trigger
