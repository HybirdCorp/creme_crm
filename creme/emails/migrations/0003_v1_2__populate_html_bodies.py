...
class Migration(DataMigration):
    def forwards(self, orm):
        for template in orm['emails.emailtemplate'].objects.all():
            template.body_html = template.body
            template.save()

        for sending in  orm['emails.emailsending'].objects.all():
            sending.body_html = sending.body
            sending.save()
    ...
    models = {
        ...
        'emails.entityemail': {
            ...
            'body_html': ('django.db.models.fields.TextField', [], {}),
            'cremeentity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['creme_core.CremeEntity']", 'unique': 'True', 'primary_key': 'True'}),
            'identifier': ('django.db.models.fields.CharField', [], {'default': "'1ZhUZ5Nu2PNYwRyhStmvFh86R7xlIE9l'", 'unique': 'True', 'max_length': '32'}),
