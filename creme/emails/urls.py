...
urlpatterns = [
    ...
    re_path(r'^mailing_list/(?P<ml_id>\d+)/recipient/add_csv[/]?$', recipient.RecipientsAddingFromCSV.as_view(), name='emails__add_recipients_from_csv'),
    ...
    re_path(r'^mails_history/(?P<mail_id>\w+)[/]?$', mail.LightWeightEmailPopup.as_view(), name='emails__view_lw_mail'),
