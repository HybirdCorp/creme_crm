...
urlpatterns = patterns('emails.views',
    ...
    (r'^campaign/(?P<campaign_id>\d+)/mailing_list/delete/(?P<ml_id>\d+)$', 'campaign.delete_ml'),
    ...
    (r'^campaign/sending/delete/(?P<sending_id>\d+)$',    'sending.delete'),
    ...
    (r'^mailing_list/recipient/delete/(?P<recip_id>\d+)$', 'recipient.delete'),
    ...
    (r'^mailing_list/(?P<ml_id>\d+)/contact/delete/(?P<contact_id>\d+)$', 'mailing_list.delete_contact'),
