...
class ButtonsTestCase(CremeTestCase):
    ...
    def test_become_can_display(self, button_class):
    ...
    def test_become_action_data(self):
        ...
        self.assertEqual(context["can_link"], True)
        self.assertEqual(context["has_perm"], False)  # no permission at all
        self.assertEqual(context["is_enabled"], True)
