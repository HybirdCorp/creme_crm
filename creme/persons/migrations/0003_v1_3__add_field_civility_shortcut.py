...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Civility.shortcut'
        db.add_column('persons_civility', 'shortcut', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Civility.shortcut'
        db.delete_column('persons_civility', 'shortcut')
