...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Organisation', fields ['siren']
        db.create_unique('persons_organisation', ['siren'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Organisation', fields ['siren']
        db.delete_unique('persons_organisation', ['siren'])
