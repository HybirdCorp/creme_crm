...
class Migration(DataMigration):
    def _set_shortcut(self, pk, shortcut):
        try:
            civ = orm['persons.civility'].objects.get(pk=1)
        except Exception as e:
            print 'Error', e
        else:
            civ.shortcut = _(u"Mrs.")
            civ.save()

    def forwards(self, orm):
        activate(settings.LANGUAGE_CODE)
        self._set_shortcut(1, _(u'Mrs.'))
        self._set_shortcut(2, _(u'Ms.'))
        self._set_shortcut(3, _(u'Mr.'))
