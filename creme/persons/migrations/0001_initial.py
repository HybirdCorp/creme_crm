...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('persons_position', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('persons', ['Position'])

        # Adding model 'Sector'
        db.create_table('persons_sector', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('persons', ['Sector'])

        # Adding model 'LegalForm'
        db.create_table('persons_legalform', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('persons', ['LegalForm'])

        # Adding model 'StaffSize'
        db.create_table('persons_staffsize', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('persons', ['StaffSize'])

        # Adding model 'Address'
        db.create_table('persons_address', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('persons', ['Address'])
        ...
        # Adding M2M table for field language on 'Contact'
        db.create_table('persons_contact_language', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contact', models.ForeignKey(orm['persons.contact'], null=False)),
            ('language', models.ForeignKey(orm['creme_core.language'], null=False))
        ))
        db.create_unique('persons_contact_language', ['contact_id', 'language_id'])

        # Adding model 'Organisation'
        db.create_table('persons_organisation', (
            ('cremeentity_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['creme_core.CremeEntity'], unique=True, primary_key=True)),
            ...
            ('siret', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('persons_position')

        # Deleting model 'Sector'
        db.delete_table('persons_sector')

        # Deleting model 'LegalForm'
        db.delete_table('persons_legalform')

        # Deleting model 'StaffSize'
        db.delete_table('persons_staffsize')

        # Deleting model 'Address'
        db.delete_table('persons_address')

        # Deleting model 'Contact'
        db.delete_table('persons_contact')

        # Removing M2M table for field language on 'Contact'
        db.delete_table('persons_contact_language')
