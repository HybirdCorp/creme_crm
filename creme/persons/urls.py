...
if not persons.contact_model_is_custom():
    ...
    urlpatterns += [
        ...
        url(r'^contact/edit/(?P<contact_id>\d+)[/]?$',                          contact.ContactEdition.as_view(),         name='persons__edit_contact'),
...
if not persons.organisation_model_is_custom():
    urlpatterns += [
        ...
        url(r'^organisation/edit/(?P<orga_id>\d+)[/]?$', organisation.OrganisationEdition.as_view(),  name='persons__edit_organisation'),
...
if not persons.address_model_is_custom():
    ...
    urlpatterns += [
        ...
        url(r'^address/edit/(?P<address_id>\d+)[/]?$',        address.AddressEdition.as_view(),          name='persons__edit_address'),
    ]
