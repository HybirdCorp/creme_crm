    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.IntegerField(max_length=2, verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('entity_pk', models.IntegerField(max_length=50, null=True, verbose_name='Entity pk', blank=True)),
                ('created', creme.creme_core.models.fields.CreationDateTimeField(default=django.utils.timezone.now, verbose_name='Creation date', editable=False, blank=True)),
                ('entity_changes', models.TextField(default=creme.activesync.models.active_sync._empty_dump, verbose_name='Entity changes')),
                ('type', models.IntegerField(max_length=1, verbose_name='', choices=[(1, 'Creation'), (3, 'Update'), (4, 'Deletion')])),
                ('where', models.IntegerField(max_length=1, verbose_name='', choices=[(1, 'In Creme'), (2, 'On server')])),
