...
class AbscissaField(JSONField):
    default_error_messages = {
        ...
        'graphtyperequired':   'The graph type is required.',  # TODO: rename
        'graphtypenotallowed': 'The graph type is not allowed.',  # TODO: rename
    ...
    def _clean_graph_type(self, data) -> int | None:  # TODO: rename
        clean_value = self.clean_value
        required = self.required
    ...
    def _value_from_unjsonfied(self, data):
        gtype = self._clean_graph_type(data)  # TODO: rename
        if gtype is None:
            return None
...
class ChartForm(CremeModelForm):
    chart = forms.ChoiceField(  # TODO: rename
        label=_('Chart type'),
