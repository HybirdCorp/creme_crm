...
class AbscissaWidget(ChainedInput):
    ...
    gtype_data_name = 'graph_type'   # TODO: rename
    cell_key_data_name = 'cell_key'
    gtype_id_data_name = 'type_id'    # TODO: rename
    ...
    def build_graph_type_choices(self):  # TODO: rename
        ...
        return [
            ...
            ) for rgraph_type in registry.chart_types
        ]
...
class AbscissaField(JSONField):
    ...
    gtype_data_name      = AbscissaWidget.gtype_data_name  # TODO: rename
    cell_key_data_name   = AbscissaWidget.cell_key_data_name
    gtype_id_data_name   = AbscissaWidget.gtype_id_data_name  # TODO: rename
    ...
    def _clean_chart_type(self, data) -> int | None:
        ...
        gtype_info = clean_value(data, self.gtype_data_name, dict, required, 'charttyperequired')
        if not gtype_info:
            raise ValidationError(
        ...
        return clean_value(gtype_info, self.gtype_id_data_name, int, required, 'charttyperequired')
    ...
    def _value_from_unjsonfied(self, data):
        ...
        return AbscissaInfo(
            ...
            parameter=self._clean_parameter(data, graph_type=chart_type),
        )
    ...
    def _value_to_jsonifiable(self, value):
        ...
        return {
            ...
            self.gtype_data_name: {
                self.gtype_id_data_name: value.chart_type,
                constraint_dname: category,
            },
...
class ChartForm(CremeModelForm):
    plot = forms.ChoiceField(label=_('Chart type'), widget=PrettySelect)
    ...
    def __init__(self, entity, *args, **kwargs):
        ...
        # Plot -----------------------------------------------------------------
        fields['plot'].choices = [(plot.name, plot.label) for plot in plot_registry]
