...
class InstanceBricksInfoBrick(core_bricks.QuerysetBrick):
    ...
    def render(self, context):
        ...
        for ibci in btc['page'].object_list:
            # NB: the instance brick for Chart always works for DETAIL & HOME,
            #     we just have to pass one of these tags
            ibci.brick = ibci.get_brick(core_bricks.BrickRegistry.Tag.DETAIL)
