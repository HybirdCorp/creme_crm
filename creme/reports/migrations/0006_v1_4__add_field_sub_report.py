...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Field.sub_report'
        db.add_column('reports_field', 'sub_report',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Report'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Field.sub_report'
        db.delete_column('reports_field', 'sub_report_id')
