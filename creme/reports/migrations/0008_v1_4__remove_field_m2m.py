...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Field.report'
        #db.alter_column('reports_field', 'report_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['reports.Report']))
        #db.alter_column('reports_field', 'report_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['reports.Report']))
        db.alter_column('reports_field', 'report_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reports.Report']))

        # Removing M2M table for field columns on 'Report'
        db.delete_table('reports_report_columns')

        # Deleting field 'Field.title'
        db.delete_column('reports_field', 'title')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Field.title'
        db.add_column('reports_field', 'title',
                      self.gf('django.db.models.fields.CharField')(default='??', max_length=100),
                      keep_default=False)

        # Changing field 'Field.report'
        db.alter_column('reports_field', 'report_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['reports.Report']))
