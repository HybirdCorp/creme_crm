...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ReportGraph.chart'
        db.add_column('reports_reportgraph', 'chart',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ReportGraph.chart'
        db.delete_column('reports_reportgraph', 'chart')
    ...
    models = {
        ...
        'reports.reportgraph': {
            ...
            'chart': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True'}),
            'cremeentity_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['creme_core.CremeEntity']", 'unique': 'True', 'primary_key': 'True'}),
