            ...
            fields=[
                ...
                (
                    ...
                    core_fields.CreationDateTimeField(
                        verbose_name='Creation date', default=now, editable=False, blank=True,
                    )
                ),
                (
                    'modified',
                    core_fields.ModificationDateTimeField(
                        verbose_name='Last modification', default=now, editable=False, blank=True,
                    )
                ),
                ...
                ('plot_name', models.CharField(max_length=100, null=True, verbose_name='Chart type')),
                ('asc', models.BooleanField(default=True, editable=False, verbose_name='ASC order')),
                ('extra_data', models.JSONField(default=dict, editable=False)),
                (
                    'linked_report',
                    models.ForeignKey(editable=False, on_delete=models.CASCADE, to=settings.REPORTS_REPORT_MODEL)
                ),
            ],
            options={
