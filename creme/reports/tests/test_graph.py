...
class ReportGraphTestCase(BrickTestCaseMixin,
    ...
    def test_fetch_by_year04(self):
        ...
        rgraph1 = ReportGraph.objects.create(
            ...
            ordinate_type=RGA_SUM, ordinate_cell_key=f'custom_field-{cf1.id}',
        )
    ...
    def test_fetch_with_cutomfields_on_x_n_y(self):
        ...
        rgraph = ReportGraph.objects.create(
            ...
            abscissa_cell_value=cf_x.id, abscissa_type=RGT_CUSTOM_YEAR,
            ordinate_type=RGA_SUM, ordinate_cell_key=f'custom_field-{cf_y.id}',
        )
    ...
    def test_fetch_with_customfk_04(self):
        ...
        rgraph1 = ReportGraph.objects.create(
            ...
            abscissa_cell_value=str(cf_enum.id), abscissa_type=RGT_CUSTOM_FK,
            ordinate_type=RGA_SUM, ordinate_cell_key=f'custom_field-{cf_int1.id}',
        )
        ...
        rgraph2 = ReportGraph.objects.create(
            ...
            abscissa_cell_value=str(cf_enum.id), abscissa_type=RGT_CUSTOM_FK,
            ordinate_type=RGA_AVG, ordinate_cell_key=f'custom_field-{cf_int2.id}',
        )
