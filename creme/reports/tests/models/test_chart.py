...
from ..base import AxisFieldsMixin, BaseReportsTestCase, Report
from ..fake_models import FakeReportsColorCategory


class ChartTestCase(AxisFieldsMixin, BaseReportsTestCase):
    ...
    def test_ordinate_info__ignore_fields_config(self):
        "Ignore FieldSConfig."
        user = self.login_as_root_and_get()
    ...
    def test_fetch_colormap__with_fk(self):
        user = self.login_as_root_and_get()
    ...
    def test_fetch__credentials(self):
