...
class Populator(BasePopulator):
    ...
    def create_reports(self, rt_obj_emit_orga):
        ...
        #try:
            ...
            #orga_filter = EntityFilter.get_latest_version(FILTER_MANAGED_ORGA)
        ...
        #opp_filter = EntityFilter.create('opportunities-gen_by_managed',
        #                                 _(u"Generated by a Creme managed organisation"),
        #                                 Opportunity, user='admin',
        #                                 conditions=[EntityFilterCondition.build_4_relation_subfilter(rtype=rt_obj_emit_orga, has=True, subfilter=orga_filter)]
        #                                )
