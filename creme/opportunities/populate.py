...
class Populator(BasePopulator):
    ...
    def populate(self, *args, **kwargs):
        ...
        create(HeaderFilterItem, pref + 'expdate', order=4, name='expiration_date', title=_(u'Expiration date'),       type=HFI_FIELD, header_filter_id=hf_id, has_a_filter=True, editable=True, sortable=True, filter_string="expiration_date__range")
