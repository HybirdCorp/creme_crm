...
class Populator(BasePopulator):
    ...
    def populate(self):
        ...
        rt_sub_targets = create_rtype((REL_SUB_TARGETS, _(u'targets the organisation/contact'), [Opportunity]),
                                      (REL_OBJ_TARGETS, _(u"targeted by the opportunity"),      [Organisation, Contact]),
                                      is_internal=True
                                     )[0]
        rt_obj_emit_orga = create_rtype((REL_SUB_EMIT_ORGA, _(u"has generated the opportunity"), [Organisation]),
...
#            from creme.billing.models import SalesOrder, Invoice, Quote
    ...
    def create_report_n_graphes(self, rt_obj_emit_orga):
        "Create the report 'Opportunities' and 2 ReportGraphes"
        ...
        # Create 2 instance block items for the 2 graphes ----------------------
