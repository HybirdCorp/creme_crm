...
class UnsuccessfulPhoneCallTestCase(view_base.BrickTestCaseMixin,
    ...
    def test_creation__default(self):
        ...
        self.assertRelationCount(1, opp, act_constants.REL_SUB_ACTIVITY_SUBJECT, activity)

        REL_SUB_PART_2_ACTIVITY = act_constants.REL_SUB_PART_2_ACTIVITY
        self.assertRelationCount(1, user.linked_contact, REL_SUB_PART_2_ACTIVITY, activity)
        self.assertRelationCount(1, self.contact1,       REL_SUB_PART_2_ACTIVITY, activity)
        self.assertRelationCount(1, self.contact2,       REL_SUB_PART_2_ACTIVITY, activity)
        self.assertRelationCount(0, deleted,             REL_SUB_PART_2_ACTIVITY, activity)
    ...
    def test_creation__relation_duplicate(self):
        ...
        REL_SUB_PART_2_ACTIVITY = act_constants.REL_SUB_PART_2_ACTIVITY
        self.assertRelationCount(1, user_contact,  REL_SUB_PART_2_ACTIVITY, activity)
        self.assertRelationCount(1, self.contact1, REL_SUB_PART_2_ACTIVITY, activity)
        self.assertRelationCount(1, self.contact2, REL_SUB_PART_2_ACTIVITY, activity)
    ...
    def test_creation__narrowed(self):
        ...
        self.assertRelationCount(1, user_contact,  REL_SUB_PART_2_ACTIVITY, activity)
        self.assertRelationCount(1, self.contact1, REL_SUB_PART_2_ACTIVITY, activity)
        self.assertRelationCount(0, self.contact2, REL_SUB_PART_2_ACTIVITY, activity)
