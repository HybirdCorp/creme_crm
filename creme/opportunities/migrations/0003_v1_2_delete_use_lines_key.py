...
class Migration(DataMigration):
    ...
    models = {
        ...
        'creme_config.settingkey': {
            'Meta': {'object_name': 'SettingKey'},
        ...
        'creme_config.settingvalue': {
            'Meta': {'object_name': 'SettingValue'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['creme_config.SettingKey']"}),
    ...
    complete_apps = ['creme_config', 'opportunities']
