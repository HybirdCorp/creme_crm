...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Opportunity.currency'
        db.add_column('opportunities_opportunity', 'currency', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['creme_core.Currency']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Opportunity.currency'
        db.delete_column('opportunities_opportunity', 'currency_id')
