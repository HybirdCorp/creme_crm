...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'SalesPhase.order'
        db.add_column('opportunities_salesphase', 'order', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)

    def backwards(self, orm):
        # Deleting field 'SalesPhase.order'
        db.delete_column('opportunities_salesphase', 'order')
