...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'Origin.description'
        db.delete_column('opportunities_origin', 'description')

        # Deleting field 'SalesPhase.description'
        db.delete_column('opportunities_salesphase', 'description')

    def backwards(self, orm):
        # Adding field 'Origin.description'
        db.add_column('opportunities_origin', 'description', self.gf('django.db.models.fields.TextField')(default='... [backward migration]'), keep_default=False)

        # Adding field 'SalesPhase.description'
        db.add_column('opportunities_salesphase', 'description', self.gf('django.db.models.fields.TextField')(default='... [backward migration]'), keep_default=False)
