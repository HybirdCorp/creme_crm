...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('events_event', (
            ...
            ('final_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=10, decimal_places=2, blank=True)),
        ))
    ...
    models = {
        ...
        'events.event': {
            'Meta': {'ordering': "('id',)", 'object_name': 'Event', '_ormbases': ['creme_core.CremeEntity']},
            ...
            'final_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '10', 'decimal_places': '2', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
