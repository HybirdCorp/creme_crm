...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'ProjectTask.duration'
        db.delete_column('projects_projecttask', 'duration')

        # Changing field 'ProjectTask.tstatus'
        db.alter_column('projects_projecttask', 'tstatus_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.TaskStatus'], on_delete=models.PROTECT))

        # Changing field 'Project.status'
        db.alter_column('projects_project', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectStatus'], on_delete=models.PROTECT))

    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'ProjectTask.duration'
        raise RuntimeError("Cannot reverse this migration. 'ProjectTask.duration' and its values cannot be restored.")

        ## Changing field 'ProjectTask.tstatus'
        #db.alter_column('projects_projecttask', 'tstatus_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.TaskStatus']))

        ## Changing field 'Project.status'
        #db.alter_column('projects_project', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ProjectStatus']))
