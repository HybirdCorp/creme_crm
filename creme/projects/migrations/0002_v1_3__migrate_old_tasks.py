...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for project_task in orm['projects.ProjectTask'].objects.all():
            parent_activity = orm['activities.Activity'].objects.get(pk=project_task.id)
            parent_activity.activity_duration = project_task.duration
            parent_activity.floating_type = 1 # NARROW
    ...
    complete_apps = ['activities', 'projects']
