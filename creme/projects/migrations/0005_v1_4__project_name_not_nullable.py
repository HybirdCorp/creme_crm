...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column('projects_project', 'name', self.gf('django.db.models.fields.CharField')(default='Unnamed project', max_length=100))

    def backwards(self, orm):
        # Changing field 'Project.name'
        db.alter_column('projects_project', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
