...
:Version: 15-02-2023 for Creme 2.5
:Copyright: Hybird
...
Its documentation is complete & quite good ; see here : https://docs.djangoproject.com/en/4.0/.
To begin, reading the `tutorial <https://docs.djangoproject.com/en/4.0/intro/overview/>`_
should be enough.
